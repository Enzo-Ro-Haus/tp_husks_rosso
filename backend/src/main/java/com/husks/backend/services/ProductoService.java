...
public interface ProductoService extends BaseService<Producto, Long> {
    ...
    List<Producto> filtrarProductos(Long tipoId, Long categoriaId, String nombre, Double precioMin, Double precioMax, Long talleId, String sistemaTalle) throws Exception;
}